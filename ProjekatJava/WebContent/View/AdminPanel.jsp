    ...
    <body id="page-top">
        ...
        <header class="masthead bg-primary text-white text-center">
            <div class="container d-flex align-items-center flex-column">
                ...
                <!-- Masthead Heading-->
                <h1 id="naslov" class="masthead-heading text-uppercase mb-0">Admin panel</h1>
                <!-- Icon Divider-->
        ...
        <% AgencijaDBS agencijaDBS = new AgencijaDBS();
        	
        ArrayList<Agencija> listaAgencija = (ArrayList<Agencija>) agencijaDBS.getAll();
		...
		<div class="container">
			<div class="row">
					...
					<table class="table table-dark">
					  <thead>
					    <tr>
					      ...
					      <th scope="col">Agencija ID</th>
					      <th scope="col">menadzer</th>
					      <th scope="col">Naziv</th>
					      <th scope="col">Lokacija</th>
					     
					      <th scope="col">Slika</th>
					      <th scope="col">Pocetak radnog</th>
					      <th scope="col">Kraj radnog</th>
					  ...
					  <% 
					  	...
					  	%>  
						    ...
						    <tr>
							      ...
							      <td><%= a.getAgencijaID() %></td>
							      <td><%= a.getMenadzer() %></td>
							      <td><%= a.getNaziv() %></td>
							      <td><%= a.getLokacija() %></td>
							      
							      <td><%= a.getSlika() %></td>
							      <td><%= a.getPocetakRadnog() %></td>
							      <td><%= a.getKrajRadnog() %></td>
							      
							      <td><a href="ServletAdminAgencija?&AgencijaID=<%=a.getAgencijaID()%>">DELETE</a></td>	
				...
				<div class="col-md-2">
					<h4>Insert agencija</h4>
					<a href="InsertAgencija.jsp">Insert</a>
				</div>
			</div>
		</div>
      ...
      <%	KorisnikDBS korisnikDBS = new KorisnikDBS(); 
      	...
      	ArrayList<Korisnik> listaKorisnika = (ArrayList<Korisnik>) korisnikDBS.getAll(); %>
       <div class="container">
			<div class="row">
				<div class="col-md-3">
					<h4>Insert korisnik</h4>
					<a href="InsertKorisnik.jsp">Insert</a>
				</div>
				<div class="col-md-8">
					<table class="table table-dark">
					  <thead>
					    <tr>
					      ...
					      <th scope="col">tipKorisnika ID</th>
					      <th scope="col">Ime</th>
					  ...
					  <% 
					  	...
					  	%>  
						    ...
						    <tr>
							      ...
							      <td><%= k.getKorisnikID() %></td>
							      <td><%= k.getTipKorisnikaID() %></td>
							      <td><%= k.getIme() %></td>
							      <td><%= k.getPrezime() %></td>
							      <td><%= k.getEmail() %></td>
							      <td><%= k.getBodovi() %></td>
							      <td><%= k.GetAktivan() %></td>
							      <td><a href="../ServletAdminKorisnik?KorisnikID=<%= k.getKorisnikID() %>&opcija=UPDATE">UPDATE</a></td>
							      <td><a href="ServletAdminKorisnik?KorisnikID=<%= k.getKorisnikID() %>&opcija=DELETE">DELETE</a></td>	
