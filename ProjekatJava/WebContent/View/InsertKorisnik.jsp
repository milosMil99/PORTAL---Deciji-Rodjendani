    ...
    <body id="page-top">
        ...
        <header class="masthead bg-primary text-white text-center">
            <div class="container d-flex align-items-center flex-column">
                ...
                <!-- Masthead Heading-->
                <h1 id="naslov" class="masthead-heading text-uppercase mb-0">INSERT KORISNIK</h1>
                <!-- Icon Divider-->
  	...
  	%>
  		<div class="container">
			<div class="row">
				...
				<div class="col-md-8">
					<form action="../ServletAdminKorisnik" method="POST">
						
						<div class="form-group">
						    <label for="tipKorisnikaID">tipKorisnikaID</label>
						    <input type="text" class="form-control" name="tipKorisnikaID" >
						  </div>
