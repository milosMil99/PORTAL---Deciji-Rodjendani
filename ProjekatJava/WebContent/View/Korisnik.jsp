...
<html>
 <head>
    ...
    <body id="page-top">
        ...
        <header class="masthead bg-primary text-white text-center">
            <div class="container d-flex align-items-center flex-column">
                ...
                <!-- Masthead Heading-->
                <h1 id="naslov" class="masthead-heading text-uppercase mb-0">Profil korisnika</h1>
                <!-- Icon Divider-->
	...
	<%
		...
		Korisnik k = (Korisnik) korisnikDBS.getKorisnikbyID(ID);  %>
        <div class="container">
			<div class="row">
				...
				<div class="col-md-8">
						...
						<div class="form-group">
						    ...
						    <input type="text" class="form-control" name="korisnikID" value=<%=k.getKorisnikID() %>>
						  </div>
						<div class="form-group">
						    <label for="tipKorisnikaID">tipKorisnikaID</label>
						    <input type="text" class="form-control" name="tipKorisnikaID" value=<%=k.getTipKorisnikaID() %> >
						  </div>
						  
						 <div class="form-group">
						    <label for="ime">Ime</label>
						    <input type="text" class="form-control" name="ime" value=<%=k.getIme()%> >
						  </div>
						  
						  <div class="form-group">
						    <label for="prezime">Prezime</label>
						    <input type="text" class="form-control" name="prezime" value=<%=k.getPrezime()%>  >
						  </div>
						  <div class="form-group">
						    <label for="email">Email</label>
						    <input type="text" class="form-control" name="email" value=<%=k.getEmail() %>>
						  </div>
						  <div class="form-group">
						    <label for="lozinka">Lozinka</label>
						    <input type="text" class="form-control" name="lozinka" value=<%=k.getLozinka() %> >
						  </div>
						  <div class="form-group">
						    <label for="bodovi">Bodovi</label>
						    <input type="text" class="form-control" name="bodovi" value=<%=k.getBodovi() %> >
						  </div>
