    ...
    <body id="page-top">
        ...
        <header class="masthead bg-primary text-white text-center">
            <div class="container d-flex align-items-center flex-column">
                ...
                <!-- Masthead Heading-->
                <h1 id="naslov" class="masthead-heading text-uppercase mb-0">Insert Agencija</h1>
                <!-- Icon Divider-->
        ...
        <div class="container">
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-8 col-xl-7">
                        ...
                        <form  method="POST" action="../ServletAdminAgencija">
                            <!-- Name input-->
                            
                           <div class="form-floating mb-3">
                          		<label for="menadzer">Menadzer</label>
                                <input class="form-control" type="text" name="menadzer" />
                            </div>
                            ...
                            <div class="form-floating mb-3">
                                ...
                                <input class="form-control" type="text" name="lokacija"  />
                            </div>
                            ...
                            <div class="form-floating mb-3">
                                ...
                                <input class="form-control" name="slika" type="text" />
                            </div>

                            <div class="form-floating mb-3">
                            	<label for="pocetakRadnog">Pocetak radnog vremena</label>
                                <input class="form-control" name="pocetakRadnog" type="text" />
                            </div>
                            
                            <div class="form-floating mb-3">
                            	<label for="krajRadnog">Kraj radnog vremena </label>
                                <input class="form-control" name="krajRadnog" type="text"/>
                            </div>
                          
                            <input class="btn btn-primary btn-xl " id="submitButton" value="Potvrdi" type="submit"/>
                        </form>
                    </div>
                </div>
            </div>
