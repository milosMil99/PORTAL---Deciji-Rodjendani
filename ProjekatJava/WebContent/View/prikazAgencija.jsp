       ...
       <!-- Navigation-->
		...
		<section class="page-section portfolio" id="portfolio">
            <div class="container">
                ...
                <% ArrayList<Agencija> listaAgencija1 = (ArrayList<Agencija>) request.getAttribute("listaAgencija"); %>
	
				<% for(Agencija s : listaAgencija1)
					{
					%>
					<% String str = s.getNaziv();
						String noSpace = str.replaceAll("\\s", ""); %>
					<div class="col-md-6 col-lg-4 mb-5">
                        <div class="portfolio-item mx-auto" data-bs-toggle="modal" data-bs-target="#<%= noSpace%>">	
                            <div class="portfolio-item-caption d-flex align-items-center justify-content-center h-100 w-100">
                                <div class="portfolio-item-caption-content text-center text-white"><i class="fas fa-plus fa-3x"></i></div>
                            </div>
                             <p><%= s.getNaziv() %></p>
                             
                             	<img class="slika" src="img\<%= s.getSlika() %>" alt="..." />
        ...
        <% ArrayList<Agencija> listaAgencija2 = (ArrayList<Agencija>) request.getAttribute("listaAgencija"); %>
	
				<% for(Agencija s1 : listaAgencija2)
					{
					%>
					<% String str = s1.getNaziv();
						String noSpace = str.replaceAll("\\s", ""); %>
					<div class="portfolio-modal modal fade" id="<%= noSpace%>" tabindex="-1" aria-labelledby="<%= s1.getNaziv()%>" aria-hidden="true">
			                        ...
			                        <div class="container">
			                            <div class="row justify-content-center">
			                                <div class="col-lg-8">
			                                    ...
			                                    <h2 class="portfolio-modal-title text-secondary text-uppercase mb-0"><%= s1.getNaziv() %></h2>
			                                    <!-- Icon Divider-->
			                                    <div class="divider-custom">
			                                        <div class="divider-custom-line"></div>
			                                        <div class="divider-custom-icon"><i class="fas fa-star"></i></div>
			                                    ...
			                                    <img class="img-fluid rounded mb-5" src="img\<%= s1.getSlika() %>" alt="..." />
			                                    <!-- Portfolio Modal - Text-->
			                                    <p class="mb-4"><%= s1.getOpis() %></p>
			                                    <form action="AgencijaServlet" method="GET">
				                                    <input type="hidden" value="<%= s1.getAgencijaID() %>" name="AgencijaID" > 
				                                    <input class="btn btn-primary" type="submit" value="Detaljnije" />                 
